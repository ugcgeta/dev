...
def oled_init(wiringpi2):
    ...
    i2c = wiringpi2.I2C()
    oled_i2c = i2c.setup(0x78)
    
    i2c.write(oled_i2c,0xAE)  # display off
...
#    i2c.write(oled_i2c,0x00)  # set display start line
#    i2c.write(oled_i2c,0xB0 | i)  # set page start address←垂直開始位置はここで決める(B0～B7)
#    i2c.write(oled_i2c,0x21) # set column addres
#    i2c.write(oled_i2c,0x00 | 0) # start column addres←水平開始位置はここで決める(0～126)
#    i2c.write(oled_i2c,0x7F) # Column Stop Address　画面をフルに使う
    
#    i2c.write(oled_i2c,0x40)
#    i2c.write(oled_i2c,0x0f)
